...
{
    $stmt = $conn->query("SELECT major.id, major.major, major.degree, dept.dept, faculty.faculty, ins.ins FROM major INNER JOIN dept  ON major.dept = dept.id INNER JOIN faculty ON dept.faculty = faculty.id INNER JOIN ins ON faculty.ins = ins.id");
    $stmt->execute();
