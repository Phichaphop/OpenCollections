...
if (isset($_GET['delete']) && isset($_GET['pic']) && isset($_GET['ins'])) {
    $id = $_GET['ins'];
    $filePath = '../resource/img/ins_logo/';
    DeleteInsCover($id, $filePath, $conn);
}

function DeleteInsCover($id, $filePath, $conn)
{
    try {
    ...
    echo "<script>window.location.href='../frm_ins.php?detail&ins=" . urlencode($id) . "';</script>";
    exit;
}
