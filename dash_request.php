                    ...
                    <?php if (!$data) { ?>
                        ...
                        foreach ($currentPageData as $row) { ?>
                            ...
                            <div class="menu-group">
                                ...
                                <div class="menu-content">
                                    <div class="icon" onclick="window.location='frm_request.php?delete&request=<?= $row['id'] ?>'">
                                        <?php include 'components/icon/delete.php'; ?>
                                    </div>

                                    <div class="icon" onclick="window.location='frm_request.php?detail&request=<?= $row['id'] ?>'">
